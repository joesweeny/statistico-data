...
require (
	...
	github.com/statistico/statistico-proto/data/go v0.0.0-20201206103606-0c0195cd0f49
	github.com/statistico/statistico-sportmonks-go-client v0.1.1-0.20210115124723-2e98df6d8cd5

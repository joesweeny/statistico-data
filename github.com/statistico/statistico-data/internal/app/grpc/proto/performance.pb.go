...
type TeamStatResponse struct {
	...
	Teams []*PerformanceTeam `protobuf:"bytes,1,rep,name=teams,proto3" json:"teams,omitempty"`
}
...
func (x *TeamStatResponse) GetTeams() []*PerformanceTeam {
	if x != nil {
		return x.Teams
	}
	return nil
...
func (x *PerformanceTeam) Reset() {
	*x = PerformanceTeam{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_app_grpc_proto_performance_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PerformanceTeam) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PerformanceTeam) ProtoMessage() {}

func (x *PerformanceTeam) ProtoReflect() protoreflect.Message {
	mi := &file_internal_app_grpc_proto_performance_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PerformanceTeam.ProtoReflect.Descriptor instead.
func (*PerformanceTeam) Descriptor() ([]byte, []int) {
	return file_internal_app_grpc_proto_performance_proto_rawDescGZIP(), []int{2}
}

func (x *PerformanceTeam) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PerformanceTeam) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_internal_app_grpc_proto_performance_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xcb, 0x01, 0x0a, 0x0f, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x52,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x60, 0x0a, 0x12, 0x50, 0x65, 0x72,
	0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x4a, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61,
	...
	0x64, 0x61, 0x74, 0x61, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x61, 0x70,
...
var file_internal_app_grpc_proto_performance_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_app_grpc_proto_performance_proto_goTypes = []interface{}{
	...
	(*PerformanceTeam)(nil),  // 2: proto.PerformanceTeam
}
var file_internal_app_grpc_proto_performance_proto_depIdxs = []int32{
	2, // 0: proto.TeamStatResponse.teams:type_name -> proto.PerformanceTeam
	0, // 1: proto.PerformanceService.GetTeamsMatchingStats:input_type -> proto.TeamStatRequest
	1, // 2: proto.PerformanceService.GetTeamsMatchingStats:output_type -> proto.TeamStatResponse
...
func file_internal_app_grpc_proto_performance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_app_grpc_proto_performance_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PerformanceTeam); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type PerformanceServiceClient interface {
	GetTeamsMatchingStats(ctx context.Context, in *TeamStatRequest, opts ...grpc.CallOption) (*TeamStatResponse, error)
}
...
func (c *performanceServiceClient) GetTeamsMatchingStats(ctx context.Context, in *TeamStatRequest, opts ...grpc.CallOption) (*TeamStatResponse, error) {
	out := new(TeamStatResponse)
	err := c.cc.Invoke(ctx, "/proto.PerformanceService/GetTeamsMatchingStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PerformanceServiceServer interface {
	GetTeamsMatchingStats(context.Context, *TeamStatRequest) (*TeamStatResponse, error)
}
...
func (*UnimplementedPerformanceServiceServer) GetTeamsMatchingStats(context.Context, *TeamStatRequest) (*TeamStatResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTeamsMatchingStats not implemented")
}
...
func _PerformanceService_GetTeamsMatchingStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TeamStatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PerformanceServiceServer).GetTeamsMatchingStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.PerformanceService/GetTeamsMatchingStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PerformanceServiceServer).GetTeamsMatchingStats(ctx, req.(*TeamStatRequest))
	}
...
var _PerformanceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTeamsMatchingStats",
			Handler:    _PerformanceService_GetTeamsMatchingStats_Handler,
		},
	},

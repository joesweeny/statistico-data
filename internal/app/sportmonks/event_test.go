...
func TestEventRequester_EventsByFixtureIDs(t *testing.T) {
	t.Run("returns two channels containing goal and substitution events", func(t *testing.T) {
		...
		a.Equal(uint64(11867297001), goalOne.ID)
		a.Equal(uint64(78), goalOne.TeamID)
		a.Equal(uint64(11867297), goalOne.FixtureID)
		a.Equal(uint64(95776), goalOne.PlayerID)
		a.Equal(uint64(13452), *goalOne.PlayerAssistID)
		a.Equal(3, goalOne.Minute)
		a.Equal("1-0", goalOne.Score)

		a.Equal(uint64(11867297001), goalTwo.ID)
		a.Equal(uint64(78), goalTwo.TeamID)
		a.Equal(uint64(11867297), goalTwo.FixtureID)
		a.Equal(uint64(95776), goalTwo.PlayerID)
		a.Equal(uint64(13452), *goalTwo.PlayerAssistID)
		a.Equal(3, goalTwo.Minute)
		a.Equal("1-0", goalTwo.Score)

		a.Equal(uint64(11867325003), subOne.ID)
		a.Equal(uint64(21), subOne.TeamID)
		a.Equal(uint64(11867325), subOne.FixtureID)
		a.Equal(uint64(1384), subOne.PlayerInID)
		a.Equal(uint64(3530), subOne.PlayerOutID)
		a.Equal(54, subOne.Minute)
		a.Nil(subOne.Injured)

		a.Equal(uint64(11867325003), subTwo.ID)
		a.Equal(uint64(21), subTwo.TeamID)
		a.Equal(uint64(11867325), subTwo.FixtureID)
		a.Equal(uint64(1384), subTwo.PlayerInID)

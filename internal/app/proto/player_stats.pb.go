...
// source: internal/app/proto/player_stats.proto
...
func (*PlayerStatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1ee0e56059c677a, []int{0}
}
...
func (*LineupResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1ee0e56059c677a, []int{1}
}
...
func (*PlayerStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1ee0e56059c677a, []int{2}
}
...
func (*Lineup) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1ee0e56059c677a, []int{3}
}
...
func (*LineupPlayer) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1ee0e56059c677a, []int{4}
}
...
func init() {
	proto.RegisterFile("internal/app/proto/player_stats.proto", fileDescriptor_c1ee0e56059c677a)
}

var fileDescriptor_c1ee0e56059c677a = []byte{
	// 510 bytes of a gzipped FileDescriptorProto
	,
}
...
var _PlayerStatsService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/app/proto/player_stats.proto",
}

...
package season // import "github.com/statistico/statistico-data/internal/proto/season"
...
func (*Season) Descriptor() ([]byte, []int) {
	return fileDescriptor_season_c616885890f83b0f, []int{0}
}
...
func init() {
	proto.RegisterFile("internal/proto/season/season.proto", fileDescriptor_season_c616885890f83b0f)
}

var fileDescriptor_season_c616885890f83b0f = []byte{
